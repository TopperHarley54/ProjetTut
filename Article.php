<?php
	...
	class article {
		...
		public function insert() {
			...
			$query = "INSERT INTO article(code_barre, nom_article, prix, prix_promo, description, photo, taille_dispo, couleur, datedebut,datefin, id_client) VALUES ('$this->code_barre','$this->nom_article','$this->prix','$this->prix_promo','$this->description','$this->photo','$this->taille_dispo','$this->couleur','$this->datedebut','$this->datefin','$this->id_magasin','$this->id_client')";
			$res = $b->query($query);
